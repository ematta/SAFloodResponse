...
data class DiscussionEntity(
    @PrimaryKey
    val threadId: String,    // Unique identifier for the discussion thread
    val reportId: String,    // Foreign key to the flood report being discussed
    val createdBy: String,   // Foreign key to the user who created the thread
    val timestamp: String    // When the discussion thread was created
)